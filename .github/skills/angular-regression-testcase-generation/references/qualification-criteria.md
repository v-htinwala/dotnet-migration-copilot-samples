...
2. Build a dependency graph from TypeScript import analysis and `@NgModule` metadata
...
**Process**:
1. Parse existing Istanbul coverage reports (`lcov.info` or `coverage-summary.json`)
...
```json
{
  "qualification": {
    ...
    "risk_based": {
      ...
      "business_criticality": {
        "overrides": {
          "src/app/payment/**": "critical",
          "src/app/auth/**": "critical",
          "src/app/core/services/order.service.ts": "high"
        },
  ...
  "test_level": "unit",
  "test_data": {
    "fixtures_dir": "src/test-data",
    "expected_outputs_dir": "src/test-data/expected",
    "data_format": "json"
  },
  "traceability": {
  ...
  "exclusions": {
    "directories": ["node_modules", ".git", "dist", ".angular", "coverage"],
    "file_patterns": ["*.module.ts", "*.routing.module.ts", "*.generated.*", "environment*.ts"]
  },
  "execution": {
    "batch_size": 5,
    "max_retries": 3,
