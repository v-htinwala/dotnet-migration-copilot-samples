...
| --------- | --------- | ----------------------------------- | -------- |
| `0.95`    | Very sensitive — captures small UI changes (tooltips, hover states) | 80–150 | Detailed functional testing |
| `0.85`    | **Default** — captures distinct screen transitions and major interactions | 30–80 | General test-case generation |
